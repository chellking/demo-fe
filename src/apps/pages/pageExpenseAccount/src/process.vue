<template>
    <div>
        ...
        <div v-if="params.processKey" class="list-panel1">
                    ...
                    <el-steps :space="286" :active="3">
                        ...
                        <el-step v-if='listData.length > 0' class="first-step">
                            ...
                            <div slot="description">
                                <el-tooltip class="item" effect="normal" :content="listData[0].deleteReason"
                                            placement="top">
                                    <p class="titleAction" @click="showList">{{listData[0].deleteReason}}</p>
                                </el-tooltip>
                                <div class="titleNumber ifbp-icon-more" style="cursor: pointer;"
                                     @click="showList"></div>
                            </div>
                        </el-step>
                        ...
                        <!-- 没审批结束的第二步骤(非同意) -->
                        <el-step
                                v-if='isNext && listData.length > 0 && !isEnd && listData[listData.length-1].deleteReason != "同意"'
                                class="second-step">
                            <div slot="title">
                                <div class="titleText">
                            ...
                            <div slot="description">
                                <el-tooltip
                                        ...
                                        placement="top">
                                    <p class="titleAction">
                                        {{listData[listData.length-1].deleteReason}}：{{listData[listData.length-1].message}}</p>
                                </el-tooltip>
                        ...
                        <el-step
                            ...
                            <div slot="description">
                                <el-tooltip
                                        ...
                                        placement="top">
                                    <p class="titleAction">{{listData[listData.length-2].deleteReason}}
                                        {{listData[listData.length-2].message}}</p>
                                </el-tooltip>
                                <div class="titleNumber ifbp-icon-check"></div>
                            </div>
                        </el-step>
                        ...
                        <el-step
                            ...
                            <div slot="description">
                                <el-tooltip
                                        ...
                                        :disabled="listData[listData.length-1].message ? false : true"
                                        placement="top">
                                    <p class="titleAction">{{listData[listData.length-1].deleteReason}}
                                        {{listData[listData.length-1].message}}</p>
                                </el-tooltip>
                                <div class="titleNumber ifbp-icon-check"></div>
                            </div>
                        </el-step>
            ...
            <!-- 按钮 -->
            <div class="fl" v-if="this.showBtn != false || this.showBtn == undefined"
                 style="margin-top:36px;margin-left:2px;">
                <!-- 待办任务不能有撤回按钮 -->
                <ul class="btnLists" v-if="this.params.stateFlage != 'his' && !isEnd && isAgree">
                    <li v-for="item in consentBtn" :key="item.key">
                        <el-button v-if="item.key!='assignAble'" type="primary" @click="clickButton(item.key)">
                            {{item.value}}
                        </el-button>
                    </li>
                    <li v-for="item in defaultBtn" :key="item.key">
                        <el-button v-if="item.key!='assignAble'" @click="clickButton(item.key)">{{item.value}}
                        </el-button>
                    </li>
                    <li class="more-btn">
                        <el-dropdown menu-align="start">
                            ...
                            <el-dropdown-menu slot="dropdown">
                                <el-dropdown-item v-for="item in hiddenBtn" :key="item.key"
                                                  @click.native="clickButton(item.key)">{{item.value}}
                                </el-dropdown-item>
                ...
                <ul>
                    <li v-for="(item,index) in listData" :key="item.startTime" style="min-width:390px;">
                        ...
                        <div class="div-content">
                            ...
                            <div style="float:right;margin-left:10px;font-size:14px;color:#888;display:inline-block">
                                {{item.startTime}}
                            </div>
                        </div>
                        <p>
